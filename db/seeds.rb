...
Rank.create(name: "Trainee", counter:1)
Rank.create(name: "Junior", counter:2)
Rank.create(name: "Middle", counter:3)
Rank.create(name: "Senior", counter:4)
Rank.create(name: "Lead", counter:5)